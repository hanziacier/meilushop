...
class Address extends Model{
    ...
    protected $auto = ['province','city','area',"uid","create_time"];
    protected $insert = ['province','city','area',"uid","create_time"];  
    protected $update = ['province','city','area',"uid","create_time"];  
