<?php /*a:4:{s:58:"/data/wwwroot/yershop/application/admin/view/ad/index.html";i:1546747402;s:63:"/data/wwwroot/yershop/application/admin/view/public/header.html";i:1531675504;s:63:"/data/wwwroot/yershop/application/admin/view/public/dialog.html";i:1520503620;s:63:"/data/wwwroot/yershop/application/admin/view/public/footer.html";i:1531675686;}*/ ?>
 <!-- 头部 -->
					    ...
					    <tr>
				          ...
				          <?php if(is_array($res['list']) || $res['list'] instanceof \think\Collection || $res['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $res['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                 <tr class="even gradeC">
										 ...
										 <td>  <img src="<?php echo htmlentities(get_cover_path($vo['cover_id'])); ?>" class="table-img" alt=""> </td>
										 <td><a href="<?php echo U('auth/edit?id='.$vo['id']); ?>"><?php echo htmlentities((isset($vo['title']) && ($vo['title'] !== '')?$vo['title']:'')); ?></a> </td>
										 <td><?php echo htmlentities((isset($vo['url']) && ($vo['url'] !== '')?$vo['url']:'')); ?></td>
										 <td><?php echo htmlentities((isset($vo['sort']) && ($vo['sort'] !== '')?$vo['sort']:'0')); ?></td>
										 <td><?php echo htmlentities((isset($vo['place']) && ($vo['place'] !== '')?$vo['place']:'0')); ?></td>
