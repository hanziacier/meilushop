<?php /*a:4:{s:61:"/data/wwwroot/yershop/application/index/view/goods/lists.html";i:1546184150;s:63:"/data/wwwroot/yershop/application/index/view/public/header.html";i:1546784250;s:62:"/data/wwwroot/yershop/application/index/view/public/color.html";i:1529863444;s:63:"/data/wwwroot/yershop/application/index/view/public/footer.html";i:1547545240;}*/ ?>
<!-- 头部 -->
     ...
     function addcart(obj,goodsid){
		       ...
		       $.post(cart_url,{goodsid:goodsid,num:num},function(data){
					 ...
					 if(data.status){  
						...
						$('.tSum').text("¥"+data.total); addpaowuxian();
					 }
					 else{
					     openerror(data);
