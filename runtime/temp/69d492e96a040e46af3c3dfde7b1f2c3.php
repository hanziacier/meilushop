<?php /*a:4:{s:66:"/data/wwwroot/yershop/application/index/view/goods/ping_lists.html";i:1546763510;s:63:"/data/wwwroot/yershop/application/index/view/public/header.html";i:1546784250;s:62:"/data/wwwroot/yershop/application/index/view/public/color.html";i:1529863444;s:63:"/data/wwwroot/yershop/application/index/view/public/footer.html";i:1546783818;}*/ ?>
<!-- 头部 -->
...
<?php endif; ?> ">
				...
				<div class="gl_wrapper">
					...
					<div class="gl_item ping">
						<a class="imgs" href="<?php echo url('goods/detail?id='.$vo['id']); ?>"><img class="gl_item_img lazy" data-original="<?php echo htmlentities(get_cover($vo['cover_id'],'path')); ?>"/>
						
						<?php if($vo['num'] < 1): ?><span class="ping-status">已售罄</span><?php endif; ?>
						</a>
						
					
						<a class="gl_item_name" href="<?php echo url('goods/detail?id='.$vo['id']); ?>"> <?php echo htmlentities($vo['title']); ?></a>
						
				<div class="ping-buy"><div class="w-goods2-price" ><strong class="t-impt"><span >￥</span><span ><?php echo htmlentities($vo['pin_price']); ?></span></strong><span>&nbsp;</span><i class="i-freeShip">包邮</i><span>&nbsp;</span><span class="t-aside del" ><span >￥</span><span><?php echo htmlentities($vo['price']); ?></span></span></div><a href="<?php echo url('goods/detail?id='.$vo['id']); ?>" class="w-btn w-btn-s" target="_blank"><em><span><?php echo htmlentities($vo['pin_max_num']); ?></span><span>人团</span></em><classname class="w-btn-split">|</classname><span >去参团</span></a></div>
