<?php /*a:4:{s:67:"/data/wwwroot/yershop/application/index/view/goods/ping_detail.html";i:1546237626;s:63:"/data/wwwroot/yershop/application/index/view/public/header.html";i:1546784250;s:62:"/data/wwwroot/yershop/application/index/view/public/color.html";i:1529863444;s:63:"/data/wwwroot/yershop/application/index/view/public/footer.html";i:1546783818;}*/ ?>
<!-- 头部 -->
...
(function(){
	$("#arealist").find(".text").bind("mouseover",function(){
...
function chooseArea(obj,pid){
	...
	$("#arealist .content, #arealist .close").hide();
					...
					<div class="num_input">
						...
						<div class="oprt t-sec"><div class="pin" ><div class="prices t-sec"><span class="t-aside" >拼团价：</span><strong class="t-impt">￥<?php echo htmlentities($info['pin_price']); ?></strong><span class="freight" >包邮</span></div>
						
						<div class="submit" onclick="pin()"  >
						
						<button class="w-btn w-btn-xl"><em ><?php echo htmlentities($info['pin_max_num']); ?>人团</em>
						
						<span class="w-btn-split">|</span><span > 我要开团</span></button></div></div><div class="buys"><div class="prices" ><span class="t-aside fn-pc" >单购价：</span>
						
						<strong class="t-sec" >￥<?php echo htmlentities($info['price']); ?>+<?php echo htmlentities($info['spress']); ?></strong><span class="t-sec t-smaller fn-pc" > 元运费</span></div><div onclick="orderCreate()" class="submit" ><button class="w-btn w-btn-sec w-btn-xl">单独购买</button></div></div>
						
						
						<ol class="t-aside tips" ><li">1. 点击“我要开团”并支付，成功开好团；</li><li ><span>2. 邀请 </span><em class="t-impt"><?php echo getmaxnum($info["id"]); ?></em><span> 个好友参团，或等系统推荐陌生人参你的团；</span></li><li>3. 人数达到数量即组团成功，立即发货。</li></ol></div>
								...
								<ul class="list_ul" id="comments">
									...
									<li class="list_li">
										<div class="div_l fl">
											...
											<p class="time"><?php echo htmlentities(date('Y-m-d H:i',!is_numeric($vo['create_time'])? strtotime($vo['create_time']) : $vo['create_time'])); ?></p>
						...
						<div class="zx_list f12">
							...
							<div class="xx_list" id="sales">
								...
								<div class="list_div">
									...
									<span class="span_05 fl"> <?php echo htmlentities(date('Y-m-d H:i',!is_numeric($vo['create_time'])? strtotime($vo['create_time']) : $vo['create_time'])); ?></span>
								</div>
						       <?php endforeach; endif; else: echo "" ;endif; ?>
								 <div class="sales">
        ...
        function pin(){
			 ...
			 //var ids=$(".caizhi .current");
               ...
               if(result){
				...
				var id=result.join(",");
				var num=$("#num_ipt").val();
				var order_url="<?php echo url("order/pin"); ?>";
