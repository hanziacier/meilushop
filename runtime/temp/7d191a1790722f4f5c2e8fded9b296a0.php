<?php /*a:4:{s:62:"/data/wwwroot/yershop/application/admin/view/module/index.html";i:1546778296;s:63:"/data/wwwroot/yershop/application/admin/view/public/header.html";i:1531675504;s:63:"/data/wwwroot/yershop/application/admin/view/public/dialog.html";i:1520503620;s:63:"/data/wwwroot/yershop/application/admin/view/public/footer.html";i:1531675686;}*/ ?>
 <!-- 头部 -->
...
<!-- 头部 --> 
			...
			<div class="content">
				...
				<div class="edit_title"><span class="title"><i class="fa fa-<?php echo htmlentities((isset($now['font']) && ($now['font'] !== '')?$now['font']:'')); ?>"></i><?php echo htmlentities((isset($meta_title) && ($meta_title !== '')?$meta_title:"")); ?></span></div>
				<div class="search">
					...
					<table class="list_table">
				       ...
				       <?php if(is_array($res['list']) || $res['list'] instanceof \think\Collection || $res['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $res['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                           <tr class="even gradeC">
							   ...
							   <td><a href="<?php echo url('index?pid='.$vo['id']); ?>"><?php echo htmlentities($vo['title']); ?></a> </td>
			                   <td><?php echo htmlentities($vo['url']); ?></td>
			                   <td><?php echo htmlentities($vo['sort']); ?></td>
		                       <td><?php if($vo['status'] == '1'): ?>正常<?php else: ?>已禁用<?php endif; ?></td>
			                   <td class="list_opr">
                                     <span class="opr_box">
