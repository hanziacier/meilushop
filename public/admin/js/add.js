            ...
            if (bCheck == true) {
                ...
                if (zuheDate.length > 0) {
                    ...
                    $.each(zuheDate, function (index, item) {
						...
						var num=""; var price="";
						var td1 = $("<td ><input style=\"border: 1px solid #ccc; \" name=\"prices[]\" class=\"l-text\" type=\"text\" value=\"\"></td><input name=\"titles[]\" class=\"l-text\" type=\"hidden\" value="+ tit +">");
                        td1.appendTo(tr);
                        var td2 = $("<td ><input style=\"border: 1px solid #ccc; \" name=\"nums[]\" class=\"l-text\" type=\"text\" value=\"\"></td>");
                        td2.appendTo(tr);
